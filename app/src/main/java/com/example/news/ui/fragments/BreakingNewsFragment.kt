...
class BreakingNewsFragment : Fragment(R.layout.fragment_breaking_news) {
    ...
    private fun hideProgressBar() {
        breakingNewsShimmerFrameLayout.stopShimmerAnimation()
        breakingNewsShimmerFrameLayout.visibility = View.INVISIBLE
        isLoading = false
    }

    private fun showProgressBar() {
        breakingNewsShimmerFrameLayout.startShimmerAnimation()
        breakingNewsShimmerFrameLayout.visibility = View.VISIBLE
        isLoading = true
    }
